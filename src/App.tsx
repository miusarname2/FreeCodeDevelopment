export default function index() {
  return (
    <div key="1" className="bg-[#202124] h-screen flex justify-center items-center">
      <div className="bg-[#2C2C2E] p-8 rounded-lg shadow-lg flex h-screen w-screen items-center justify-center">
        <div className="flex flex-col items-center mr-12">
          ...
          <div className="space-y-4">
            <button className="flex items-center text-white space-x-2 transition-colors duration-200 rounded-lg overflow-hidden hover:bg-[#3C3C3E]" onClick={
              (e)=>{
                e.preventDefault();
            ...
            <button className="flex items-center text-white space-x-2 transition-colors duration-200 rounded-lg overflow-hidden hover:bg-[#3C3C3E]">
        ...
        <div className="bg-[#3C3C3E] p-4 rounded-lg">
          ...
          <ul className="text-[#8E8E93]">
            <li className="mb-2 flex items-center space-x-2 hover:bg-[#3C3C3E] rounded-lg">
              ...
              />
              <div>
                <p className="text-xs">~/Desktop/swift intro/intro to swiftui</p>
                <p>MyPlayground</p>
              </div>
            </li>
